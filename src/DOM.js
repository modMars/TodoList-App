...
const displayManager = (() => {
	...
	const refreshTodos = () => {
		const todoContainer = document.querySelector('.to-dos__container')
		// const todoList = document.querySelector('.to-dos__list')
		...
		projectName.textContent = `~/ ${document.querySelector('.project-container__list').id}`
		todoContainer.append(wrapper)
		const todoList = document.createElement('div')
		todoList.classList.add('to-dos__list')
...
const domInterface = (() => {
	const getCurrentProject = () => {
		let output = ''
		const currentProject = document.querySelector('.project-container__list').id
